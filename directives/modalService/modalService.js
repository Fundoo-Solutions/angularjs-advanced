angular.module('fundoo.services', []).factory('createDialog',
  ["$document", "$compile", "$rootScope", "$controller", "$timeout", '$q',
  function ($document, $compile, $rootScope, $controller, $timeout, $q) {
    var defaults = {
      id: null,
      template: null,
      templateUrl: null,
